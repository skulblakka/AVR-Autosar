 ...
 * @file
 *
 * @brief       Application configuration for resource management test procedure 6
 *
 * @date        2020-07-20
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task2,   3,  128,     1, NO_AUTOSTART, BASIC,  PREEMPTIVE,     NULL, 0b0)
OS_CONFIG_TASK_END

OS_CONFIG_INT_BEGIN

    OS_CONFIG_INT_DEF(INT0_vect, 2)
...
OS_CONFIG_RESOURCE_BEGIN
    OS_CONFIG_RESOURCE_DEF(Res1, 2)
    OS_CONFIG_RESOURCE_DEF(Res2, 3)
    OS_CONFIG_RESOURCE_DEF(Res3, 3)
