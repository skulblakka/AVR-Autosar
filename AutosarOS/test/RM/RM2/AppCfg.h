 ...
 * @file
 *
 * @brief       Application configuration for resource management test procedure 2
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  128,     1,    AUTOSTART, BASIC, NON_PREEMPTIVE,     NULL, 0b0)
    OS_CONFIG_TASK_DEF(Task2,   2,  128,     1, NO_AUTOSTART, BASIC, NON_PREEMPTIVE,     NULL, 0b0)
    OS_CONFIG_TASK_DEF(Task3,   4,  128,     1, NO_AUTOSTART, BASIC, NON_PREEMPTIVE,     NULL, 0b0)
OS_CONFIG_TASK_END
