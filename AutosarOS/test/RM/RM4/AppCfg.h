 ...
 * @file
 *
 * @brief       Application configuration for resource management test procedure 4
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task2,   2,  128,     1, NO_AUTOSTART, BASIC, PREEMPTIVE,     NULL, 0b0)
    OS_CONFIG_TASK_DEF(Task3,   3,  128,     1, NO_AUTOSTART, BASIC, PREEMPTIVE,     NULL, 0b0)
OS_CONFIG_TASK_END
...
OS_CONFIG_RESOURCE_BEGIN
    OS_CONFIG_RESOURCE_DEF(RES_SCHEDULER, 4)
