 ...
 * @file
 *
 * @brief       Application configuration for resource management test procedure 1
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    OS_CONFIG_TASK_DEF(Idle,    0,  128,     1,    AUTOSTART, BASIC,  PREEMPTIVE,     NULL, 0b0)
    OS_CONFIG_TASK_DEF(Task1,   1,  128,     1,    AUTOSTART, BASIC,  PREEMPTIVE,     NULL, 0b0)
OS_CONFIG_TASK_END

OS_CONFIG_INT_BEGIN

    OS_CONFIG_INT_DEF(INT0_vect, 5)
...
OS_CONFIG_RESOURCE_BEGIN
    OS_CONFIG_RESOURCE_DEF(Res1, 5)
    OS_CONFIG_RESOURCE_DEF(Res2, 1)
    OS_CONFIG_RESOURCE_DEF(Res3, 1)
    OS_CONFIG_RESOURCE_DEF(Res4, 1)
    OS_CONFIG_RESOURCE_DEF(Res5, 1)
    OS_CONFIG_RESOURCE_DEF(Res6, 1)
    OS_CONFIG_RESOURCE_DEF(ResA, 0)
