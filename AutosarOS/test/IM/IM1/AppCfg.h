 ...
 * @file
 *
 * @brief       Application configuration for interrupt management test procedure 1
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task2,   2,  128,     1, NO_AUTOSTART,    BASIC,  NON_PREEMPTIVE,     NULL,    0b000)
OS_CONFIG_TASK_END
