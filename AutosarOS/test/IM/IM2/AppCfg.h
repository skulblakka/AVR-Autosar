 ...
 * @file
 *
 * @brief       Application configuration for interrupt management test procedure 2
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  128,     1,    AUTOSTART,    BASIC,      PREEMPTIVE,     NULL,    0b000)
    OS_CONFIG_TASK_DEF(Task2,   2,  128,     1, NO_AUTOSTART,    BASIC,      PREEMPTIVE,     NULL,    0b000)
OS_CONFIG_TASK_END
