 ...
 * @file
 *
 * @brief       Application configuration for alarm management test procedure 2
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  256,     1,    AUTOSTART, BASIC, PREEMPTIVE,     NULL, 0b0)
    OS_CONFIG_TASK_DEF(Task2,   2,  256,     1, NO_AUTOSTART, BASIC, PREEMPTIVE,     NULL, 0b0)
OS_CONFIG_TASK_END
...
OS_CONFIG_ALARM_BEGIN
    OS_CONFIG_ALARM_DEF(Alarm1, Counter1, false, 0b0, ALARM_ACTION_TASK, Task2, 1, 1)
OS_CONFIG_ALARM_END
