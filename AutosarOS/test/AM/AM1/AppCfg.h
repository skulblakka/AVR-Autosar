 ...
 * @file
 *
 * @brief       Application configuration for alarm management test procedure 1
 *
 * @date        2020-07-16
...
OS_CONFIG_COUNTER_BEGIN
    OS_CONFIG_COUNTER_DEF(Counter1, 16, 2, 1, SOFTWARE, 1)
OS_CONFIG_COUNTER_END

OS_CONFIG_ALARM_BEGIN
    OS_CONFIG_ALARM_DEF(Alarm1, Counter1, false, 0b0, ALARM_ACTION_TASK, Task1, 1, 1)
OS_CONFIG_ALARM_END
