 ...
 * @file
 *
 * @brief       Application configuration for alarm management test procedure 6
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  256,     1,    AUTOSTART,    BASIC, NON_PREEMPTIVE,     NULL, 0b00)
...
OS_CONFIG_ALARM_BEGIN
    OS_CONFIG_ALARM_DEF(Alarm1, Counter1, false, 0b01, ALARM_ACTION_EVENT, Task2, 1, 1)
OS_CONFIG_ALARM_END
