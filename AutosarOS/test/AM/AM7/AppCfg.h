 ...
 * @file
 *
 * @brief       Application configuration for alarm management test procedure 7
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task2,   2,  256,     1,    AUTOSTART, EXTENDED, PREEMPTIVE,     NULL, 0b10)
    OS_CONFIG_TASK_DEF(Task3,   3,  256,     1, NO_AUTOSTART,    BASIC, PREEMPTIVE,     NULL, 0b00)
    OS_CONFIG_TASK_DEF(Task4,   4,  256,     1, NO_AUTOSTART,    BASIC, PREEMPTIVE,     NULL, 0b00)
OS_CONFIG_TASK_END
...
OS_CONFIG_ALARM_BEGIN
    OS_CONFIG_ALARM_DEF(Alarm1, Counter1, false, 0b10, ALARM_ACTION_EVENT, Task2, 1, 1)
OS_CONFIG_ALARM_END
