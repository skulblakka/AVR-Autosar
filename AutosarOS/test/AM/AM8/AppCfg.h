 ...
 * @file
 *
 * @brief       Application configuration for alarm management test procedure 8
 *
 * @date        2020-07-20
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  256,     1,    AUTOSTART,    BASIC, PREEMPTIVE,     NULL, 0b10)
OS_CONFIG_TASK_END
...
OS_CONFIG_ALARM_BEGIN
    OS_CONFIG_ALARM_DEF(Alarm1, Counter1, false, 0b10, ALARM_ACTION_EVENT, Task1, 1, 1)
OS_CONFIG_ALARM_END
