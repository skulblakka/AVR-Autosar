 ...
 * @file
 *
 * @brief       Application configuration for task management test procedure 6
 *
 * @date        2020-07-13
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  128,     1, AUTOSTART,    EXTENDED,  NON_PREEMPTIVE,     NULL,    0b00)
    OS_CONFIG_TASK_DEF(Task2,   2,  128,     1, NO_AUTOSTART, EXTENDED,  NON_PREEMPTIVE,     NULL,    0b10)
OS_CONFIG_TASK_END
