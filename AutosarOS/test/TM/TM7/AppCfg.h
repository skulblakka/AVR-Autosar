 ...
 * @file
 *
 * @brief       Application configuration for task management test procedure 7
 *
 * @date        2020-07-13
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  128,     2, AUTOSTART,    BASIC,  NON_PREEMPTIVE,     NULL,    0b00)
    OS_CONFIG_TASK_DEF(Task2,   2,  128,     2, NO_AUTOSTART, BASIC,  NON_PREEMPTIVE,     NULL,    0b00)
    OS_CONFIG_TASK_DEF(Task3,   3,  128,     2, NO_AUTOSTART, BASIC,  NON_PREEMPTIVE,     NULL,    0b00)
OS_CONFIG_TASK_END
