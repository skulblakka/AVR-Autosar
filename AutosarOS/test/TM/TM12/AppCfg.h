 ...
 * @file
 *
 * @brief       Application configuration for task management test procedure 12
 *
 * @date        2020-07-13
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task2,   1,  128,     3, NO_AUTOSTART, BASIC,  PREEMPTIVE,     NULL,    0b000)
    OS_CONFIG_TASK_DEF(Task3,   1,  128,     3, NO_AUTOSTART, BASIC,  PREEMPTIVE,     NULL,    0b000)
OS_CONFIG_TASK_END
