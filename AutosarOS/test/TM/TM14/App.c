 ...
 * @file
 *
 * @brief       Application code for task management test procedure 14
 *
 * @date        2020-07-13
...
TASK(Task1)
{
    ...
    stat = ActivateTask(Task4);
    assert(stat == E_OK);

    stat = ActivateTask(Task5);
    assert(stat == E_OK);

    stat = ActivateTask(Task6);
    assert(stat == E_OK);

    stat = ActivateTask(Task7);
    assert(stat == E_OK);

    stat = ActivateTask(Task8);
    assert(stat == E_OK);

    stat = ActivateTask(Task9);
    assert(stat == E_OK);

    stat = ActivateTask(Task10);
    assert(stat == E_OK);

    stat = ActivateTask(Task11);
    assert(stat == E_OK);

    stat = ActivateTask(Task12);
    assert(stat == E_OK);

    stat = ActivateTask(Task13);
    assert(stat == E_OK);

    stat = ActivateTask(Task14);
    assert(stat == E_OK);

    stat = ActivateTask(Task15);
    assert(stat == E_OK);

    stat = ActivateTask(Task16);
    assert(stat == E_OK);

    for (uint8_t i = 0; i < 8; i++) {
        EventMaskType mask = 1 << i;
...
TASK(Task2)
{
    for (uint8_t i = 0; i < 8; i++) {
        EventMaskType mask = 1 << i;
        StatusType stat = ClearEvent(mask);
        assert(stat == E_OK);
    }
