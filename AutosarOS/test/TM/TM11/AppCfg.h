 ...
 * @file
 *
 * @brief       Application configuration for task management test procedure 11
 *
 * @date        2020-07-13
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  128,     1, NO_AUTOSTART,    BASIC,  PREEMPTIVE,     NULL,    0b000)
    OS_CONFIG_TASK_DEF(Task2,   2,  128,     1,    AUTOSTART, EXTENDED,  PREEMPTIVE,     NULL,    0b010)
    OS_CONFIG_TASK_DEF(Task3,   2,  128,     1, NO_AUTOSTART,    BASIC,  PREEMPTIVE,     NULL,    0b000)
    OS_CONFIG_TASK_DEF(Task4,   3,  128,     1, NO_AUTOSTART,    BASIC,  PREEMPTIVE,     NULL,    0b000)
OS_CONFIG_TASK_END
