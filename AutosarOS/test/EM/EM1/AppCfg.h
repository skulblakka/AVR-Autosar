 ...
 * @file
 *
 * @brief       Application configuration for event management test procedure 1
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   1,  128,     1,    AUTOSTART,    BASIC,  NON_PREEMPTIVE,     NULL,    0b000)
    OS_CONFIG_TASK_DEF(Task2,   3,  128,     1, NO_AUTOSTART, EXTENDED,  NON_PREEMPTIVE,     NULL,    0b001)
OS_CONFIG_TASK_END
