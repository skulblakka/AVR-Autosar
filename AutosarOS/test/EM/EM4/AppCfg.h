 ...
 * @file
 *
 * @brief       Application configuration for event management test procedure 4
 *
 * @date        2020-07-16
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task1,   2,  128,     1,    AUTOSTART,    BASIC,  PREEMPTIVE,     NULL,    0b000)
    OS_CONFIG_TASK_DEF(Task2,   3,  128,     1,    AUTOSTART, EXTENDED,  PREEMPTIVE,     NULL,    0b011)
    OS_CONFIG_TASK_DEF(Task3,   1,  128,     1, NO_AUTOSTART, EXTENDED,  PREEMPTIVE,     NULL,    0b100)
    OS_CONFIG_TASK_DEF(Task4,   4,  128,     1, NO_AUTOSTART,    BASIC,  PREEMPTIVE,     NULL,    0b000)
OS_CONFIG_TASK_END
