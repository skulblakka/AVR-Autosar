 ...
 * @file
 *
 * @brief       Application configuration for schedule tables test procedure 3
 *
 * @date        2020-07-20
...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(Task2, 2,  256,     1, NO_AUTOSTART,   EXTENDED,  NON_PREEMPTIVE,     NULL,    0b00)
OS_CONFIG_TASK_END
...
OS_CONFIG_SCHEDULE_TABLE_BEGIN
    /* Schedule table ST1 */
    OS_CONFIG_SCHEDULE_TABLE_DEF_BEGIN(ST1, Counter1, false, true, 2)
    ...
    OS_CONFIG_SCHEDULE_TABLE_DEF_BEGIN(ST2, Counter1, false, false, 0)
        OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINTS_BEGIN(1)
            /* Expiry point at 0 */
            OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_DEF_BEGIN( 1, 1, 0)
                OS_CONFIG_SCHEDULE_TABLE_TASK_ACTIONS_BEGIN
                    OS_CONFIG_SCHEDULE_TABLE_TASK_ACTION_DEF(Task2)
                OS_CONFIG_SCHEDULE_TABLE_TASK_ACTIONS_END
                OS_CONFIG_SCHEDULE_TABLE_EVENT_ACTIONS_BEGIN
    ...
    /* Schedule table ST3 */
    OS_CONFIG_SCHEDULE_TABLE_DEF_BEGIN(ST3, SYSTEM_COUNTER, false, false, 0)
        OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINTS_BEGIN(1)
            /* Expiry point at 0 */
            OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_DEF_BEGIN( 1, 1, 0)
                OS_CONFIG_SCHEDULE_TABLE_TASK_ACTIONS_BEGIN
