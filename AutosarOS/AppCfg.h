...
//OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_TASK_DEF(SEP1, T8)
//OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_TASK_DEF(SEP2, T9)
//OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_EVENT_DEF(SEP3, T8, 0x01)
//OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_EVENT_DEF(SEP4, T9, 0x01)
//
//OS_CONFIG_SCHEDULE_TABLE_BEGIN
    //OS_CONFIG_SCHEDULE_TABLE_DEF_BEGIN(STable1, C5, false, false, 10)
        //OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_DEF_BEGIN(0)
            //OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_TASK(SEP1)
            //OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_TASK(SEP2)
            //OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_EVENT(SEP3)
            //OS_CONFIG_SCHEDULE_TABLE_EXPIRY_POINT_EVENT(SEP4)
