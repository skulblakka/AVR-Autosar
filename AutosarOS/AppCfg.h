...
OS_CONFIG_TASK_BEGIN
    OS_CONFIG_TASK_DEF(Idle, 0,  64,     1, AUTOSTART,      BASIC,      PREEMPTIVE,     NULL)
    OS_CONFIG_TASK_DEF(T1,   4,  64,     1, AUTOSTART,      BASIC,      PREEMPTIVE,     IntRes2)
    OS_CONFIG_TASK_DEF(T2,   7,  64,     1, AUTOSTART,      BASIC,      PREEMPTIVE,     IntRes1)
    OS_CONFIG_TASK_DEF(T3,   9,  64,     1, NO_AUTOSTART,   EXTENDED,   NON_PREEMPTIVE, NULL)
    OS_CONFIG_TASK_DEF(T4,  10,  64,     3, NO_AUTOSTART,   BASIC,      NON_PREEMPTIVE, NULL)
    OS_CONFIG_TASK_DEF(T5,   5,  64,     2, NO_AUTOSTART,   BASIC,      NON_PREEMPTIVE, NULL)
    OS_CONFIG_TASK_DEF(T6,   7,  64,     2, NO_AUTOSTART,   BASIC,      PREEMPTIVE,     IntRes1)
OS_CONFIG_TASK_END
