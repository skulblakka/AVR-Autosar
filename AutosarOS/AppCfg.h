...
OS_CONFIG_TASK_BEGIN
    ...
    OS_CONFIG_TASK_DEF(T1,   4, 128,     1, AUTOSTART,      BASIC,      PREEMPTIVE,     IntRes2)
    OS_CONFIG_TASK_DEF(T2,   7, 128,     1, AUTOSTART,      BASIC,      PREEMPTIVE,     IntRes1)
    OS_CONFIG_TASK_DEF(T3,   9, 128,     1, NO_AUTOSTART,   EXTENDED,   NON_PREEMPTIVE, NULL)
    OS_CONFIG_TASK_DEF(T4,  10, 128,     3, NO_AUTOSTART,   BASIC,      NON_PREEMPTIVE, NULL)
